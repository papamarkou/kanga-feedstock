...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kanga-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13697&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kanga-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kanga` can be installed with:

```
conda install kanga
```

It is possible to list all of the versions of `kanga` available on your platform with:
